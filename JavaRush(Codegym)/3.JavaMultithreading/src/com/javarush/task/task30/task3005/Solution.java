...
//        }
          if(d==null||d.cs==null||d.cs.size()<1||d.cs.get(0).bs==null
                  ||d.cs.get(0).bs.size()<1||d.cs.get(0).bs.get(0).as==null
                  ||d.cs.get(0).bs.get(0).as.size()<1||d.cs.get(0).bs.get(0).as.get(0).flag==false){
              System.out.println("Oops!");
          } else{
              System.out.println("A's flag is true");
          }
